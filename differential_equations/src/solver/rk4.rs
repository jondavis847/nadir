    ...
    T: Integrable,
{
    ...
    while t < *tstop {
        ...
        let k1 = func(&x, parameters, t);
        let k2 = func(&(x.clone() + k1.clone() * half_dt), parameters, t + half_dt);
        let k3 = func(&(x.clone() + k2.clone() * half_dt), parameters, t + half_dt);
        let k4 = func(&(x.clone() + k3.clone() * *dt), parameters, t + *dt);

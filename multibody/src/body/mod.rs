...
impl BodyBuilder {
    ...
    pub fn connect_inner_joint(
        ...
        if self
            ...
            .is_some()
        {
            return Err(BodyErrors::InnerJointExists(
                self.name
                    .clone(),
            ));
        }
    ...
    pub fn sample(
        ...
        let mass_properties = if let Some(mp_builder) = &self.mass_properties {
            ...
            return Err(BodyErrors::NoMassProperties(
                self.name
                    .clone(),
            ));
        };
...
impl Body {
    pub fn calculate_gravity(&mut self, gravity: &mut Gravity) {
        ...
        let body_from_base = &inner_joint
            .cache
            .transforms
            .ob_from_base;
        let g_vec = gravity
        ...
        self.state
            .gravity_force_base = g_vec;
        // transform to the body frame
        self.state
            .gravity_force_body = body_from_base
            .0
            .rotation
            .transform(&g_vec);
    }
    ...
    pub fn calculate_gravity_celestial(&mut self, celestial: &mut CelestialSystem) {
        let g_vec = celestial.calculate_gravity(
            &self
                .state
                .position_base,
        );
        ...
        let q = self
            ...
            .attitude_base;
        self.state
            .gravity_force_body = q.transform(&g_vec);
    }

    pub fn calculate_magnetic_field(&mut self, celestial: &mut CelestialSystem) {
        let b_vec = celestial.calculate_magnetic_field(
            &self
                .state
                .position_base,
        );
        self.state
            .magnetic_field_base = b_vec;
        // transform to the body frame
        let q = &self
            .state
            .attitude_base;
        self.state
            .magnetic_field_body = q.transform(&b_vec);
    }
    ...
    pub fn calculate_external_force(&mut self) {
        ...
        let gravity_force_body = Force::from(Vector6::new(
            ...
            0.0,
            self.state
                .gravity_force_body[0],
            self.state
                .gravity_force_body[1],
            self.state
                .gravity_force_body[2],
        ));

        // sum the forces
        self.state
            .external_spatial_force_body = gravity_force_body
            + self
                .state
                .actuator_force_body
            + self
                .state
                .environments_force_body;

        // write values for reporting
        self.state
            .external_force_body = *self
            .state
            .external_spatial_force_body
            .translation();
        self.state
            .external_torque_body = *self
            .state
            .external_spatial_force_body
            .rotation();
    }
    ...
    pub fn update_acceleration(&mut self) {
        ...
        let base_from_body = &(transforms.base_from_jof * transforms.jof_from_ob)
            .0
            .rotation;
        let joint_a = inner_joint
            .cache
            .a;
        let body_a = body_from_joint * joint_a;
        self.state
            .acceleration_body = *body_a.translation();
        self.state
            .angular_accel_body = *body_a.rotation();
        ...
        self.state
            .acceleration_base = base_from_body.transform(
            &(body_a.translation()
                + self
                    .state
                    .angular_rate_body
    ...
    pub fn update_state(&mut self) {
        ...
        self.state
            .velocity_body = *body_v.translation();
        self.state
            .velocity_base = body_v_in_base_translation;
        self.state
            .angular_rate_body = *body_v.rotation();
        let body_from_base = base_from_body
            .0
            .inv();
        self.state
            .position_base = body_from_base
            .translation
            .vec();
        self.state
            .attitude_base = UnitQuaternion::from(&body_from_base.rotation);

        // reset actuator force and environment force to be updated later
        self.state
            .actuator_force_body *= 0.0;
        self.state
            .environments_force_body *= 0.0;
        self.state
            .internal_momentum_body *= 0.0;
        ...
        if let Some(id) = &self.writer_id {
                ...
                .get_mut(id)
            {
                ...
                writer.float_buffer[6] = self
                    .state
                    .angular_accel_body[0];
                writer.float_buffer[7] = self
                    .state
                    .angular_accel_body[1];
                writer.float_buffer[8] = self
                    .state
                    .angular_accel_body[2];
                ...
                writer.float_buffer[24] = self
                    .state
                    .position_base[2];
                writer.float_buffer[25] = self
                    .state
                    .velocity_base[0];
                writer.float_buffer[26] = self
                    .state
                    .velocity_base[1];
                writer.float_buffer[27] = self
                    .state
                    .velocity_base[2];
                writer.float_buffer[28] = self
                    .state
                    .velocity_body[0];
                writer.float_buffer[29] = self
                    .state
                    .velocity_body[1];
                writer.float_buffer[30] = self
                    .state
                    .velocity_body[2];
                let act_torque = self
                    .state
                ...
                writer.float_buffer[37] = self
                    .state
                    .magnetic_field_base[0];
                writer.float_buffer[38] = self
                    .state
                    .magnetic_field_base[1];
                writer.float_buffer[39] = self
                    .state
                    .magnetic_field_base[2];
                writer.float_buffer[40] = self
                    .state
                    .magnetic_field_body[0];
                writer.float_buffer[41] = self
                    .state
                    .magnetic_field_body[1];
                writer.float_buffer[42] = self
                    .state
                    .magnetic_field_body[2];
                writer.float_buffer[43] = self
                    .state
                    .kinetic_energy;
                writer.float_buffer[44] = self
                    .state
                    .potential_energy;
...
impl BodyRef {
    ...
    pub fn get_outer_joints(&self) -> Vec<Weak<RefCell<Joint>>> {
        match &self.0 {
            BaseOrBody::Body(body) => body
                .borrow()
                .outer_joints
                .clone(),
            BaseOrBody::Base(base) => base
                .borrow()
                .outer_joints
                .clone(),
        }

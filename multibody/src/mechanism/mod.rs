            ...
            if let Some(body) = bodies.get(id) {
                match i {
                    0 => {
                        ...
                        self.state
                            .linear_momentum += body
                            .state
                            .linear_momentum_body;
                        self.state
                            .angular_momentum += body
                            .state
                    ...
                    _ => {
                        ...
                        let first_body = bodies
                            .get(&self.bodies[0])
                            .unwrap();
                        let base_to_mechanism = first_body
                            .state
                            .attitude_base;
                        let body_to_base = body
                            .state
                            .attitude_base
                            .inv();
                        ...
                        self.state
                            .linear_momentum += body_to_mechanism.transform(
                            &body
                                .state
                                .linear_momentum_body,
                        );
                        self.state
                            .angular_momentum += body_to_mechanism.transform(
                            &body
                                .state
                                .angular_momentum_body,
                        );

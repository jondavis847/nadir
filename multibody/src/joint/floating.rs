...
use nalgebra::{DMatrix, DVector, Matrix6x1, Vector1, Vector3, Vector6};
use rotations::{
...
impl FloatingState {
    pub fn new(attitude: Quaternion, omega: Vector3<f64>, position:Vector3<f64>, velocity: Vector3<f64>) -> Self {        
        Self { attitude, omega, position, velocity }
    }
}

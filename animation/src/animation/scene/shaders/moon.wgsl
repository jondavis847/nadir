...
@group(1) @binding(0) var moon_sampler: sampler;
@group(1) @binding(1) var moon_texture: texture_2d<f32>; 
...
@vertex
fn vs_main(vertex: Vertex, moon: Moon) -> Output {
    ...
    let normal_matrix = mat3x3<f32>(
        moon.normal_matrix_0,
        moon.normal_matrix_1,
        moon.normal_matrix_2,
    );
...
fn fs_main(in: Output) -> FragOutput {
    ...
    let color = textureSample(moon_texture, moon_sampler, in.uv).rgb;

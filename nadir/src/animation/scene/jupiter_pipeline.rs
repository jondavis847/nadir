...
#[derive(Debug)]
pub struct JupiterBindGroup(pub wgpu::BindGroup);

#[derive(Debug)]
pub struct JupiterPipeline {
...
impl JupiterPipeline {
    pub fn new(
        ...
        const VERTEX_LABEL: &str = "jupiter.vertex.buffer";
        const INSTANCE_LABEL: &str = "jupiter.instance.buffer";
        const SHADER_LABEL: &str = "jupiter.shader";
        const PIPELINE_LABEL: &str = "jupiter.pipeline";
        const SHADER_FILE: &str = include_str!("shaders/jupiter.wgsl");

...
impl CelestialAnimation {
        ...
        match body {
            CelestialBodies::Earth => {
                ...
                let earth_mesh = celestial_mesh(
                    ...
                    earth_polar_radius,
                    Material::Basic { color: Color::WHITE },
                );
                self.meshes
                    .insert(
                        CelestialMeshes::Earth,
                        earth_mesh,
                    );
                ...
                self.meshes
                    .insert(
                        CelestialMeshes::EarthAtmosphere,
                        atmosphere_mesh,
                    )
            }
            CelestialBodies::Jupiter => self
                .meshes
                .insert(
                    ...
                    celestial_mesh(
                        ...
                        71492000.0,
                        66854000.0,
                        Material::Phong { color: Color::ORANGE, specular_power: 32.0 },
                    ),
                ),
            CelestialBodies::Mars => self
                .meshes
                .insert(
            ...
            CelestialBodies::Mercury => self
                ...
                .insert(
                    ...
                    celestial_mesh(
                        ...
                        2440500.0,
                        2438300.0,
                        Material::Phong { color: Color::WHITE, specular_power: 32.0 },
                    ),
                ),
            CelestialBodies::Moon => self
                .meshes
                .insert(
            ...
            CelestialBodies::Sun => {
                ...
                self.meshes
                    .insert(
                        CelestialMeshes::SunCorona,
                        corona_mesh,
                    )
            }
            CelestialBodies::Uranus => self
                .meshes
                .insert(
    ...
    pub fn update_body(&mut self, body: CelestialBodies, position: DVec3, rotation: DQuat) {
        match body {
            CelestialBodies::Earth => {
                if let Some(earth) = self
                    .meshes
                    .get_mut(&CelestialMeshes::Earth)
                {
                ...
                if let Some(atmosphere) = self
                    .meshes
                    .get_mut(&CelestialMeshes::EarthAtmosphere)
                {
            ...
            CelestialBodies::Jupiter => {
                if let Some(body) = self
                    .meshes
                    .get_mut(&CelestialMeshes::Jupiter)
                {
            ...
            CelestialBodies::Mercury => {
                if let Some(body) = self
                    .meshes
                    .get_mut(&CelestialMeshes::Mercury)
                {
                    body.update(position, rotation);
                }
            }
            ...
            CelestialBodies::Neptune => {
                if let Some(body) = self
                    .meshes
                    .get_mut(&CelestialMeshes::Neptune)
                {
                    body.update(position, rotation);
                }
            }
            ...
            CelestialBodies::Saturn => {
                if let Some(body) = self
                    .meshes
                    .get_mut(&CelestialMeshes::Saturn)
                {
                    body.update(position, rotation);
                }
            }
            CelestialBodies::Sun => {
                ...
                if let Some(body) = self
                    .meshes
                    .get_mut(&CelestialMeshes::SunCorona)
                {
                    body.update(position, rotation);
                }
            }
            CelestialBodies::Uranus => {
                if let Some(body) = self
                    .meshes
                    .get_mut(&CelestialMeshes::Uranus)
                {
                    body.update(position, rotation);
                }
            }
...
fn celestial_mesh(
    ...
    Mesh {
        ...
        geometry: Geometry::Ellipsoid64(
            ...
            .unwrap(), //TODO: drop this unwrap and fix animation errors to use thiserror
        ),
        material,
        state: GeometryState {
